...
\newcommand{\folgez}[1]{\bigl(#1\bigr)_{n\in\mathbb{N}}}
\newcommand{\folgea}[1]{\bigl(#1\bigr)_{n\in\mathbb{N}^*}}
\newcommand{\Folge}[1]{\left(#1\right)_{n\in\mathbb{N}^*}}
\newcommand{\Folgez}[1]{\left(#1\right)_{n\in\mathbb{N}}}
\newcommand{\Reihe}[1]{\left(\sum\limits_{i=0}^n #1\right)_{n\in\mathbb{N}}}
\newcommand{\ReiheEins}[1]{\left(\sum\limits_{i=1}^n #1\right)_{n\in\mathbb{N}}}
