...
\\[0.2cm]
\hspace*{1.3cm}
$\ds |a_{n_0+h}| \cdot |u|^{n_0+h} > |a_{n_o}| \cdot |u|^{n_0} \cdot \left(\frac{|u|}{\frac{1}{2} \cdot (R+|u|)}\right)^h$. \hspace*{\fill} $(6)$
\\[0.2cm]
Da $|u| > R$ ist, folgt
\\[0.2cm]
\hspace*{1.3cm}
...
\exercise
\begin{enumerate}[(a)]
\item Der \href{http://de.wikipedia.org/wiki/Binomialkoeffizient}{Binomial-Koeffizient} $n \choose k$
...
\item Überlegen Sie sich, wie Sie für zwei Potenz-Reihen 
      ...
      \hint
      Sie sollen sich bei Ihrer Rechnung nicht um die Konvergenz der Reihen kümmern.  Dieser Hinweis
...
\\[0.2cm]
definiert.  Wir hatten bereits im ersten Semester eine explizite Formel für $a_n$ hergeleitet.  In
...
\\[0.2cm]
\hspace*{1.3cm}
$(x + x^2) \cdot f(x) = \sum\limits_{n=0}^\infty a_{n} \cdot x^n - a_0 \cdot x^0 - a_1 \cdot x^1$.
\\[0.2cm]
