...
$\bigl(f(n)\bigr)_{n\in\mathbb{N}^*}$ oder $\bigl(f_n\bigr)_{n\in\mathbb{N}^*}$ oder noch kürzer als $\bigl(f_n\bigr)_n$.  Dabei ist $f_n$ als Abkürzung für $f(n)$ zu verstehen. 
...
Die Reihe $\ds\folge{\sum_{i=0}^{n} a_i}$ ist genau dann konvergent, wenn es für alle 
...
\item Die Reihe
      ...
      \\[0.2cm]
      ist nach dem Leibniz-Kriterium bedingt konvergent, aber nicht absolut konvergent, denn die Reihe der Absolutbeträge ist
