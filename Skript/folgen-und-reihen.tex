...
\proof
Es sei $a := \lim\limits_{n\rightarrow\infty} a_n$. 
...
\proof
Wenn $\folge{a_n}$ eine Cauchy-Folge ist, dann finden wir eine Zahl
...
der Reihe $\folge{\sum_{i=1}^n a_i}$ \blue{zugrunde liegende Folge}.
...
\begin{Satz}[Cauchy'sches Konvergenz-Kriterium für Reihen] 
