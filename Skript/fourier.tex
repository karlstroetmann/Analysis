...
\mbox{$f:\mathbb{R} \rightarrow \mathbb{R}$} gegeben ist, die \emph{periodisch} mit der
...
\begin{Definition}[Fourier-Reihe]
  ...
  \end{equation}
  als die mit den Folgen $\folge{a_n}$ und $\folge{b_n}$ gebildete \blue{Fourier-Reihe.}
\end{Definition}
...
\\[0.3cm]
\hspace*{1.3cm}
$I_{n,k} = 0$ \quad und \quad $J_{n,k} = 0$ \quad für $n\not=k$.
\\[0.3cm]
...
\item Die Koeffizienten $a_n$ ergeben sich als 
      ...
      periodisch mit der Periode $2\cdot\pi$ und andererseits eine gerade Funktion.
