...
Wir beweisen zunächst durch Induktion über $k$, dass für alle $k\in\mathbb{N}_0$ 
\begin{equation}
  \label{eq:taylorDiff}
  \begin{array}[t]{lcl}    
...
$n\in \mathbb{N}_0$ den \blue{Abbruch-Fehler vom Grad $n$} als
\\[0.3cm]
\hspace*{1.3cm}
...
\item[I.A.:] $n=1$.  Es gilt
  ...
  \\[0.2cm]
  denn $n!$ ist für $n\in\mathbb{N}_0$ so definiert, dass $0! = 1$ gilt.
\pagebreak
...
Um auszurechnen, wie viele Glieder benötigt werden um $\pi$ auf eine
...
Konkret zeigen wir durch vollständige Induktion, dass für alle $i\in\mathbb{N}_0$ die Ungleichung
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
\hspace*{1.3cm}
$f(x_n) \geq 0$ \quad für alle $n \in \mathbb{N}_0$ gilt.  
\begin{enumerate}
\item[I.A.] $n=0$.  
