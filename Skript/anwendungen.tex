...
Eine Funktion $f:[a,b] \rightarrow [a,b]$ ist eine \colorbox{orange}{\blue{kontrahierende Abbildung}} wenn es eine
reelle Zahl $q$ mit $q < 1$ gibt, so dass 
\\[0.2cm]
\hspace*{1.3cm}
\colorbox{red}{\colorbox{orange}{\framebox{$\forall x,y \in [a,b]: |f(x) - f(y)| \leq q \cdot  |x - y|$}}}  
\\[0.2cm]
gilt.  Wir bezeichnen die Zahl $q$ als den \colorbox{orange}{\blue{Kontraktions-Koeffizienten}}.
\eod
\end{Definition}
...
\\[0.2cm]
denn wir hatten ja vorausgesetzt, dass die Ungleichung $|f'(t)| < q$ für alle
...
\\[0.2cm]
Diese Summe wird als \colorbox{orange}{\blue{Teleskop-Summe}} bezeichnet.
Daraus folgt sofort 
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
\hspace*{1.3cm}
\colorbox{orange}{\blue{schwach kontrahierende Abbildung}} 
\\[0.2cm]
