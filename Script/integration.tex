...
\\[0.2cm]
und dass heißt gerade, dass sich die beiden Stamm-Funktionen $F_1$ und $F_2$ nur um eine Konstante
unterscheiden.   
...
\item Die Umkehrfunktion der Funktion $x \mapsto \sinh(x)$ können Sie auf den natürlichen
      ...
      beechnet haben, dann finden Sie anschließend $x$ nach der Formel $x = \ln(\alpha)$.
