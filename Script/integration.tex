...
In diesem Kapitel beschäftigen wir uns mit der Frage, wie die Fläche zwischen einer Kurve, die durch
...
\\[0.2cm]
\hspace*{1.3cm}
$\ds \int\limits_{1}^\infty \frac{1}{x^\alpha}\, dx$ \quad für $\alpha > 0$.
\\[0.2cm]
Falls $\alpha \not= 1$ ist,  gilt 
\\[0.2cm]
\hspace*{1.3cm}
