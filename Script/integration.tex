...
\\[0.2cm]
gegeben, dass wir nun berechnen.  Zun\"achst f\"uhren wir die Koordinaten-Transformation
...
$\ds h = \frac{b - a}{n}$.
\\[0.2cm]
Das Teilst\"uck des Graphen, das von dem Punkt $\bigl\langle x, f(x) \bigr\rangle$  zu dem Punkt 
$\bigl\langle x + h, f(x+h) \bigr\rangle$ kann f\"ur kleine Werte von $h$ n\"aherungsweise
