...
\begin{Definition}[Geordneter Körper]  \hspace*{\fill} \linebreak
  ...
  \emph{verträglich} ist.  Dazu müssen die beiden folgenden Bedingungen erfüllt sein:
  \begin{enumerate}
...
Körper dann auch $x \cdot z \leq y \cdot z$ gelten muss.  Subtrahieren wir auf beiden Seiten der Ungleichung
\\[0.2cm]
\hspace*{1.3cm}
$x \leq y$
\\[0.2cm]
...
Das nächste Lemma zeigt, dass sich Ungleichungen bei Multiplikation mit nicht positiven Zahlen
umdrehen. 
...
\\[0.2cm]
gilt und diese Aussage ist offenbar äquivalent zu der Behauptung. \qed
...
Abschnitts noch eine andere Konstruktion der reellen Zahlen als \emph{unendliche Dezimalbrüche}, die
auf \href{http://en.wikipedia.org/wiki/Simon_Stevin}{Simon Stevin} (1548-1620) zurück geht.  Dazu
...
\\[0.2cm]
ist keine Dedekind-Menge, da das Maximum dieser Menge ist $-1$ und diese Zahl ist selber ein Element
...
Addition die Körper-Axiome gelten.  Aus Zeitgründen verzichten wir darauf und verweisen statt dessen
...
diskutiert die Konstruktion der reellen Zahlen mit Hilfe von Dedekind-Mengen ausführlich als dies in
