...
Zeitgründen nicht in voller Länge diskutieren.  Die in diesem Abschnitt präsentierten Details sind zwar eine gute Übung zur
Mengenlehre,  werden aber für den weiteren Verlauf der Vorlesung nicht benötigt.  
...
\item $\langle K, 0, + \rangle$ ist eine kommutative Gruppe.
      ...
      \begin{enumerate}
        ...
        \item $\exists y \in K: y + x = 0$.
              ...
              Dasjenige $y \in K$, für welches $y + x = 0$ gilt, wird als das \emph{additive Inverse} von $x$ 
...
da sie in einer noch näher zu spezifizierenden Weise \emph{unvollständig} ist.  Zur Präzisierung dieser Aussage
...
Konstruktion viel zu schwerfällig.  Wir skizzieren  daher zum Abschluss dieses
Abschnitts noch eine andere Konstruktion der reellen Zahlen als \emph{unendliche Dezimalbrüche}.  Dazu
