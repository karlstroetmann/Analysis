...
\begin{Definition}[Vollständige Ordnung]
  ...
  \item Zu jeder nicht-leeren und nach unten beschränkte Menge $X \subseteq M$ exxistiert ein
        Infimum in $M$. \eod
  \end{enumerate}
\end{Definition}
...
\begin{Definition}[Angeordneter Körper]
  Ein \emph{angeordneter Körper} ist ein 6-Tupel 
  \\[0.2cm]
  \hspace*{1.3cm}
  ...
  \item $+: \mathbb{K} \times \mathbb{K} \rightarrow \mathbb{K}$
        ...
        ist eine binäre Operation auf $\mathbb{K}$, so dass $\langle \mathbb{K}, 0, + \rangle$
        eine kommutatve Gruppe ist, für alle $x,y,z \in \mathbb{K}$ gilt also:
        \begin{enumerate}
        \item $(x + y) + z = x + (y + z)$,
        \item $x + y = y + x$,
        \item $0 + x = x$,
        \item $\exists y \in \mathbb{K}: x + y = 0$.
              ...
              Dasjenige $y \in \mathbb{K}$, für welches $x + y = 0$ gilt, ist dann eindeutig bestimmt und wird mit
              $-x$ bezeichnet.
        \end{enumerate}
  \item $\cdot: \mathbb{K} \times \mathbb{K} \rightarrow \mathbb{K}$

        ist eine binäre Operation auf $\mathbb{K}$, so dass $\langle \mathbb{K}\backslash\{0\}, 1, \cdot \rangle$
        eine kommutative Gruppe ist, für alle $x,y,z \in \mathbb{K} \backslash\{0\}$ gilt also:
        \begin{enumerate}
        ...
        \item $\exists y \in \mathbb{K}: x \cdot y = 1$.
              ...
              Das eindeutig bestimmte $y \in \mathbb{K}$, für das $x \cdot y = 1$ gilt, wird mit $\frac{1}{x}$ bezeichnet.
        \end{enumerate}
  \item Die Operationen $+$ und $\cdot$ genügen dem Distributiv-Gesetz
        \\[0.2cm]
        \hspace*{1.3cm}
        $x \cdot (y + z) = x \cdot y + x \cdot z$.
  \item $\leq: \mathbb{K} \times \mathbb{K} \rightarrow \mathbb{B}$
    
        ist eine binäre Relation auf $\mathbb{K}$, so dass das Paar $\langle \mathbb{K}, \leq
       \rangle$ eine lineare Ordnung ist.  Für alle
        ...
        \end{enumerate}
  \item Definieren wir die binäre Relation $<: \mathbb{K} \times \mathbb{K} \rightarrow \mathbb{B}$
        für alle $x,y \in \mathbb{K}$ durch die Festlegung
        \\[0.2cm]
        \hspace*{1.3cm}
        $x < y \stackrel{\mathrm{def}}{\Longleftrightarrow} x \leq y \wedge x \not= y$
        \\[0.2cm]
        so sind die Operationen $+$ und $\cdot$ mit der Relation $<$ in folgender Weise verträglich:
        \begin{enumerate}
        \item $0 < x \wedge 0 < y \rightarrow 0 < x + y$,
        \item $0 < x \wedge 0 < y \rightarrow 0 < x \cdot y$,
        \end{enumerate}
\end{enumerate}
Falls die Ordnung $\langle \mathbb{K}, \leq \rangle$ zusätzlich eine vollständige Ordnung ist, wenn
also zu jeder nicht-leeren nach unten beschränkten Menge $M \subseteq \mathbb{K}$ ein Infimum
existiert, dann ist die Struktur  $\langle \mathbb{K}, 0, 1, +, \cdot, \leq \rangle$ ein vollständig
angeordneter Körper.  \eod
\end{Definition}
...
\item Die Struktur
      ...
      \\[0.2cm]
      ist ein angeordneter Körper,  aber wir hatten früher bereits gesehen, dass die Ordnung $\langle \mathbb{Q}, \leq \rangle$
      keine vollständige Ordnung ist und daher ist $\mathcal{Q}$ kein vollständig angeordneter Körper.
\item Die Struktur 
      \\[0.2cm]
      \hspace*{1.3cm}
      $\mathcal{R} := \langle \mathbb{R}, 0, 1, +, \cdot, \leq \rangle$ 
      \\[0.2cm]
      ist ein vollständig angeordneter Körper.  Es lässt sich zeigen, dass diese Struktur bis auf
      Isomorphie der einzige vollständig angeordnete Körper ist.  Wenn also
      \\[0.2cm]
      \hspace*{1.3cm}
      $\mathcal{K} := \langle \mathbb{K}, \widehat{0}, \widehat{1}, \widehat{+}, \hat{\cdot}, \widehat{\leq} \rangle$ 
      \\[0.2cm]
      ein weiterer vollständig angeordneter Körper ist, dann gibt es eine bijektive Funktion
      \\[0.2cm]
      \hspace*{1.3cm}
      $f: \mathbb{R} \rightarrow \mathbb{K}$
      \\[0.2cm]
      die mit den Operationen $+$, $\cdot$ und $\leq$ verträglich ist, es gilt dann also
      \begin{enumerate}
