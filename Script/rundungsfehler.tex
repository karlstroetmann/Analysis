...
Die Antwort ist, dass für $n = 2097152$ der Wert $\frac{1}{n}$ so klein ist, dass die Summe
\\[0.2cm]
\hspace*{1.3cm}
$\ds 15.403683 + \frac{1}{n}$
\\[0.2cm]
so nahe bei $15.403683$ liegt, dass sie auf den Wert $15.403683$ abgerundet wird.  Um diesen Effekt näher
