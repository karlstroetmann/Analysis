...
\item \emph{Lehrbuch der Analysis, Teil 1 und Teil 2 von} Harro Heuser \cite{heuser:2003,heuser:2008}.
...
\section{Eine Bitte}
Diese Skript enthält noch eine Menge Tipp-Fehler.  Sollte Ihnen ein Fehler auffallen, so bitte ich
