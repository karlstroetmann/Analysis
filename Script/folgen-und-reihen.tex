...
v      Für die Partial-Summen zeigen wir durch Induktion über $n$, dass 
      \begin{equation}
        \label{eq:seq0}        
...
\item Wir betrachten die Folge $\folge{q^n}$ für eine Zahl $q \in \mathbb{R}$.
      ...
      für $|q| < 1$
      \\[0.2cm]
      \hspace*{1.3cm} $\ds\sum\limits_{i=0}^{\infty} q^i = \bruch{1}{1-q}$.
      \\[0.2cm]
      Die Reihe
      \\[0.2cm]
      \hspace*{1.3cm}
...
\begin{Korollar} \lb
Wenn die Reihe $\Reihe{a_i}$ konvergent ist, dann ist die Folge $\folge{a_n}$ eine Null-Folge.  
\end{Korollar}
...
$\ds\Folge{\sum\limits_{i=1}^{n} \bruch{1}{i^2}}$ konvergiert.
...
Reihe $\Reihe{\bruch{1}{i}}$ eine divergente Minorante der Reihe
  $\Reihe{\bruch{1}{\sqrt{i}}}$ ist:
\\[0.2cm]
\hspace*{1.3cm}
$
\begin{array}{llcll}
...
Reihe $\Reihe{a_i}$ ist.  Dazu zeigen wir durch Induktion über $n$, dass folgendes gilt:
\\[0.2cm]
\hspace*{1.3cm}
