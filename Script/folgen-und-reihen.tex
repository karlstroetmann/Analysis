...
beschränkt, denn die Folge $(a_n)_{n\in\mathbb{N}}$ ist ja nach oben beschränkt durch eine Zahl $S$
und diese Zahl $S$ ist sicher auch eine obere Schranke von $M$.  Als nicht-leere und nach oben
...
$s-\bruch{\varepsilon}{2} < s$ folgt $s-\bruch{\varepsilon}{2} \in M$.  Damit existiert
...
$n>K$ di e folgende Kette von Ungleichungen:
\\[0.2cm]
\hspace*{1.3cm}
$
\begin{array}{lcl}
...
\\[0.2cm]
\hspace*{1.3cm}
$ \sum\limits_{i=1}^{\infty} (-1)^i \cdot  a_i \;\leq\; a_0. $
\\[0.2cm]
