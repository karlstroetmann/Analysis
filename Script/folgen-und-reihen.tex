...
\item[(a)] Es seien $a,b \in \mathbb{R}$.  Die Folge $(a_n)_{n\in\mathbb{N}}$ werde durch Induktion wie folgt
           ...
           Ansatz $\alpha_n = \lambda^n$ lösen können.  Sie werden dabei für $\lambda$ zwei mögliche Werte
...
\begin{enumerate}
\item Wir betrachten die Folge $\folge{\bruch{1}{n\cdot (n+1)}}$.
...
\item[I.A.:] $n=0$.
      \\[0.2cm]
      \hspace*{1.3cm} $s_{2\cdot 0+1} = s_1 = - a_1$.
\item[I.S.:] $n \mapsto n+1$ 
             \\[0.2cm]
\hspace*{1.3cm}
$ 
