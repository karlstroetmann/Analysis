...
\\[0.2cm]
\hspace*{1.3cm}
$\ds \frac{x}{1 - x - x^2} = \frac{1}{\sqrt{5}} \cdot \left(\frac{1}{1 - x \cdot \varphi} -
  \frac{1}{1 - x \cdot \overline{\varphi}}\right)$  \hspace*{\fill} $(*)$
\\[0.2cm]
\hspace*{1.3cm}
mit $\varphi = \frac{1}{2} \cdot (1 + \sqrt{5})$ \quad und \quad 
$\overline{\varphi} = 1 - \varphi = \frac{1}{2} \cdot (1 - \sqrt{5})$
\\[0.2cm]
darstellen.  Hier sind $\varphi$ und $\overline{\varphi}$ gerade die Inversen der Nullstellen $x_1$
und $x_2$ des Polynoms
\\[0.2cm]
\hspace*{1.3cm}
$p(x) = x^2 + x - 1$.
\\[0.2cm]
...
\\[0.2cm]
\hspace*{1.3cm}
$\ds x^2 + x - 1 = (x_1 - x) \cdot (x_2 - x) = x_1 \cdot x_2 \cdot \Bigl(1 - \frac{x}{x_1}\Bigr) \cdot \Bigl(1 - \frac{x}{x_2}\Bigr)$ 
\\[0.2cm]
und damit besteht zwischen $x_1$, $x_2$ und $\varphi$, $\overline{\varphi}$ die Beziehung 
\\[0.2cm]
\hspace*{1.3cm}
$\ds \varphi = \frac{1}{x_1}$ \quad und \quad $\ds \overline{\varphi} = \frac{1}{x_2}$.
\\[0.2cm]
