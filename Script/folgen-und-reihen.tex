...
Eigenschaften des Supremums einer Menge $M$ benutzt, die zwar offensichtlich sind, die wir aber auch
...
\\[0.2cm]
\hspace*{1.3cm}
$y < x \wedge x \in M \rightarrow x \in M$,
\\[0.2cm]
denn wenn $x$ eine untere Schranke der Mehrheit aller Folgenglieder ist, dann ist sicher jeder Zahl 
