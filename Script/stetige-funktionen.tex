...
Wir haben nun alles Material zusammen, um den Begriff der \emph{Ableitung} definieren zu können, welcher
...
\item Fall: $h < 0$.
      ...
      \hspace*{1.3cm} $\bruch{f(x+h) - f(x)}{h} \geq 0$.
\end{enumerate}
Da der Differential-Quotient in jedem Fall größer-gleich $0$ ist, muss $f'(x) \geq 0$
gelten.
\vspace*{0.2cm}
...
$f'(x_0) = 0 \wedge f''(x_0) > 0$.
\\[0.2cm]
erfüllt ist, dann hat die Funktion an der Stelle $x_0$ ein strenges lokales Minimum. \eox
