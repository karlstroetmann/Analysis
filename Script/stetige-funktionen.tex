...
\texttt{f} nicht an derselben Stelle mehrfach berechnet wird.  Wir erreichen dies, indem wir den Funktionswert,
...
\\[0.3cm]
Der Satz von L'H\^opital lässt sich iteriert anwenden.  Beispielsweise gilt
\\[0.3cm]
\hspace*{1.3cm}
