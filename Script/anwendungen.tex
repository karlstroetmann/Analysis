...
\begin{equation}
  ...
  \framebox{$\ds \textsl{taylor}(f,x) := \sum\limits_{n=0}^\infty \bruch{f^{(n)}(0)}{n!} \cdot  x^n$.}
\end{equation}
\pagebreak
...
\href{http://en.wikipedia.org/wiki/Leonard_Euler}{Leonard Euler} (1707 --- 1783) zurück gehende Formel
\\[0.2cm]
\hspace*{1.3cm}
