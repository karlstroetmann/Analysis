...
ausgehend von einem gewählten Startwert $x_1$ die übrigen Folgenglieder $x_{n}$ induktiv durch die
Festlegung 
\\[0.2cm]
\hspace*{1.3cm}
$x_{n+1} = f(x_n)$ 
...
Zahl reelle Zahl $q$ mit $q < 1$ gibt, so dass 
\\[0.2cm]
\hspace*{1.3cm}
...
Iteration.  Zur  Eliminierung dieser Rundungfehler führen wir daher in Zeile 8
